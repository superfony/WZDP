...
//    private TextView tv;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.sr_info, container, false);
        return view;
    }
...
//        tv = (TextView) getView().findViewById(R.id.show_title);
        ...
        myAdapter = new MyAdapter(getActivity(), R.layout.sr_listitem_info, als);
...
//        requestPram.methodName = RequestParamConfig.ehvMaterialprocedure;
        ...
        requestAction.queryBundle.putString("txt","tabletest.txt");// 测试语句
        httpModule.executeRequest(requestAction, new CharXmlHandler(),
                new ProcessResponse(), RequestType.TXTTEST);
    }
