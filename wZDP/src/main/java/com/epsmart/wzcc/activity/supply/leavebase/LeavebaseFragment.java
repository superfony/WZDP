 ...
 * 验收列表界面
 */
public class LeavebaseFragment extends CommonFragment {
    private View view;
    // 初始化分页标签
    private LeaveViewBuild viewBuild;
    // 申明PopupWindow对象引用
    private String TAG = LeavebaseFragment.class.getName();
    @Override
                    ...
                    public void onItemClick(AdapterView<?> arg0, View arg1,
                      ...
                      if (position == 0
                        ...
                        WorkOrder workOrder = paginationWidget
                              ...
                              //发货通知编号
                        Field DELIVERINFORMCOD = workOrder.fields.get("RESERV_NO");
                        Intent intent = new Intent();
                        intent.putExtra("RESERV_NO",DELIVERINFORMCOD.fieldContent);
                        intent.setClass(activity, LeavebaseAct.class);
    ...
    public void processQueryCondition(QueryCondition condition) {
        requestPram.methodName = RequestParamConfig.warehouseList;
