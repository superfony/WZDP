...
public class UnitInforFragment extends BaseFragment {
    private View view;
    // 验收信息
    private Button basic_info;
    // 验收明细
    private Button stat_info;
    private String TAG = "UnitInforFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Common.replaceRightFragment(getActivity(), new BasicInfoFat(), false,
                R.id.info_container);
        return view;
    }
            ...
            public void onClick(View v) {
                if (btn == basic_info) {
                    ...
                    Common.replaceRightFragment(getActivity(),
                            new BasicInfoFat(), false, R.id.info_container);
                } else {
                ...
                if (btn == stat_info) {
                    ...
                    Common.replaceRightFragment(getActivity(),
                            new StatisticalFat(), false, R.id.info_container);
                } else {
