...
import com.epsmart.wzcc.common.CommonRegex;
import com.epsmart.wzcc.http.request.AsyncHttpPost;
...
import com.epsmart.wzcc.http.xml.parser.sax.DefaultSaxXmlParser;
...
public class BaseHttpModule {
	...
	private class DefaultCallback implements RequestCallback {
		...
		public void onFail(Exception e) {
			e.printStackTrace();
			Log.i("BaseHttp", "requestListener="+requestListener);
			if (null != requestListener)
